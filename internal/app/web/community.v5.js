...
function makeCard(item) {
  ...
  for (const text of [item.sharerName || "匿名用户", typeLabel, timeText(item.created)]) {
    if (text) head.append(element("small", { className: "community-line" }, text));
  }
  card.append(head);
