// GIF89a encoder v4. Stabilized subject motion, shared adaptive palette and uniform 80ms timing.
// Literal LZW blocks reset before the code width grows, prioritizing correctness.
// 支持动作序列图的两种规格：4×4 共16帧每帧256×256，5×5 共25帧每帧128×128。
const SPEC_BY_FRAMES = { 16: { size: 256 }, 25: { size: 128 } };
const FRAME_DELAY = 8;
